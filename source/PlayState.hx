	...
	override public function create()
	{
		...
		switch(engineName)
		{
			case 'bit_omor':
				waterText = SONG.song
				+ " "
				+ CoolUtil.difficultyString() // DE stands for David Engine
				+ " - " + engineName + "is a bitchass motherfucker. he said Big black balls for no context. He is not cool and should die in hell. Engine (KE 1.2)"

			default:
				waterText = SONG.song
				+ " "
				+ CoolUtil.difficultyString() // DE stands for David Engine
				+ " - " + engineName + "Engine (KE 1.2)"
		}
